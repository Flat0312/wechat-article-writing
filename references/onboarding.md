...
5. When the dependency check passes, invoke the root `cheat-on-content` Skill for status inspection and compare the observed schema with its migrations registry.
